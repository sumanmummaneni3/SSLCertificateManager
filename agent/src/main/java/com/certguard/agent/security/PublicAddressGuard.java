 ...
 * </ol>
 *
 * <p>This class is deliberately dependency-free (no Spring, no Lombok).
 * It is applied agent-side ONLY when agent_type = PLATFORM_SCANNER
 * (customer agents scan private space by design).
...
public final class PublicAddressGuard {
     ...
     *   <li>CGNAT 100.64.0.0/10 -- shared address space (RFC 6598).
     *   <li>169.254.0.0/16 -- belt-and-braces; cloud metadata services live here.
    ...
    /** fc00::/7 -- IPv6 Unique Local Addresses (RFC 4193). isSiteLocalAddress() does NOT cover these. */
